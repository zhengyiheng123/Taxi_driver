package cinyida.com.car_driver.navigation;
...
import cinyida.com.car_driver.navigation.Bean.StrategyBean;
import cinyida.com.car_driver.navigation.util.Utils;
...
//    private NaviLatLng startLatlng = new NaviLatLng(39.993537, 116.472875);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startPosition = (PositionEntity) getIntent().getSerializableExtra("startPosition");
        endPosition = (PositionEntity) getIntent().getSerializableExtra("endPosition");
        endLatlng =new NaviLatLng(endPosition.latitue,endPosition.longitude);
        startLatlng =new NaviLatLng(startPosition.latitue,startPosition.longitude);
