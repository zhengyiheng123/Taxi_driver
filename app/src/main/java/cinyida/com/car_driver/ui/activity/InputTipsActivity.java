...
import cinyida.com.car_driver.ui.adapter.InputTipsAdapter;
...
public class InputTipsActivity extends Activity implements SearchView.OnQueryTextListener, Inputtips.InputtipsListener, OnItemClickListener, View.OnClickListener {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        if (mCurrentTipList != null) {
            ...
            setResult(Target_Address_Activity.RESULT_CODE_INPUTTIPS, intent);
            this.finish();
        }
    }
...
//        setResult(Target_Address_Activity.RESULT_CODE_KEYWORDS, intent);
//        this.finish();
        return false;
    }
